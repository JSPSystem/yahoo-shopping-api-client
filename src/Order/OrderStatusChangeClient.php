 ...
 * 注文ステータス変更API
 * 
 * @link https://developer.yahoo.co.jp/webapi/shopping/orderStatusChange.html
 */
class OrderStatusChangeClient extends BaseApiClient
{
    /**
     * 本番環境URL
     * 
     * @var string
     */
    const URL = 'https://circus.shopping.yahooapis.jp/ShoppingWebService/V1/orderStatusChange';
     ...
     * @var string
     */
    const TEST_URL = 'https://test.circus.shopping.yahooapis.jp/ShoppingWebService/V1/orderStatusChange';
